...
ActiveRecord::Schema.define(version: 20170731033829) do
  ...
  add_index "managements", ["area_id"], name: "index_managements_on_area_id", using: :btree
  add_index "managements", ["manager_id"], name: "index_managements_on_manager_id", using: :btree
  ...
  add_foreign_key "managements", "areas"
end
